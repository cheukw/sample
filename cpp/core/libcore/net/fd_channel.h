...
public:
    FdChannel(EventLoop* loop, net_socket_t fd, bool watch_read_event, bool watch_write_event);
    ~FdChannel();
...
public:
	net_socket_t fd() const { return fd_; }
...
private:
    void HandleEvent(net_socket_t fd, short which);
    static void HandleEvent(net_socket_t fd, short which, void* v);
